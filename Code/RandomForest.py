...
def suppvm(arrayfeatures,trials):
    ...
    #            print("Trial :" , str(k))
        ...
        #            print(len(type1test.index),len(type2test.index))
                    ...
                    clf = svm.SVC(kernel=kern,C=c,class_weight='balanced',random_state=50)
    ...
    for k in trials:
        ...
        #            print("Trial :" , str(k))
            ...
            #            print(len(type1test.index),len(type2test.index))
                        ...
                        x_training = x_training[arrayfeatures[position]]
                        x_testing = x_testing[arrayfeatures[position]]
                        clf = MLPClassifier(activation =act,hidden_layer_sizes=hidden,max_iter=10000,alpha=alpha1,random_state=1)
                        clf.fit(x_training,trainGeneTarget)
                        y_pred = clf.predict(x_testing)
            #            print ("Accuracy : " ,metrics.accuracy_score(testGeneTarget,y_pred))
            #            print ("Precision for fold : " ,metrics.precision_score(testGeneTarget,y_pred)) 
...
def main():
    ...
    printout.to_csv('C:/Users/Will/DropBox/Disso/Python/Models/UpdatedRFSummary.csv',index=False)
    ...
    SVMout.to_csv('C:/Users/Will/DropBox/Disso/Python/Models/UpdatedSVMSummary.csv',index=False)
    ...
    MLPout.to_csv('C:/Users/Will/DropBox/Disso/Python/Models/UpdatedMLPSummary.csv',index=False)
